...
| `data/provisions.csv` | 73 | Provision-level coding: penalty tiers, animal-scope classification, ancillary orders, and (from 2026-09-15) its own row-level `verification_tier` |
| `data/amendments.csv` | 40 | Reform history, with enactment date and effective date tracked separately |
| `data/sources.csv` | 96 | Every claim traces to a source with a retrieval date and verification tier |
